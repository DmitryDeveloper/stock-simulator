...
public class ResourcePile : Building
{
    ...
    private float m_ProductionSpeed = 0.5f; //backing field (it means that we have declared setter and getter for that field)
    //prefix "m_" means that property is private and accessable only from current class
